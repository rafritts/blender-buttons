"""E2E for Cluster 5 — hollow vessel + boolean robustness:
  ...
  G106/G127 — the hollow engine (surface retired → guidance://techniques/shell, SPEC-21 §4) carves a solid into an OPEN, watertight-walled vessel in
...
# ---- G106/G127: the hollow engine makes an open cup -----------------------------------
clean()
